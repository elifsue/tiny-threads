...
import { Menu, X, Layout, ChevronRight, Eye, Pencil, Maximize2, HelpCircle } from "lucide-react";
...
export default function WireframeShell({ children }: { children: React.ReactNode }) {
  ...
  const { mode, setMode, isLofi } = useWireframeMode();
  ...
  }, [fullScreen, showHelp, currentIndex, navigate, isLofi, setMode]);
        ...
        <div className="w-[270px] h-full flex flex-col">
          ...
          <div className="px-5 py-4" style={{ borderTop: "1px solid rgba(255,255,255,0.06)" }}>
            <p className="text-[10px] text-center" style={{ color: "#5a5a7a" }}>
              {isLofi ? "Lo-fi" : "Hi-fi"} wireframes &middot; Desktop
            </p>
          </div>
        </div>
      </aside>
