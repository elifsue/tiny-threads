        ...
        <div className="flex-1 flex items-center justify-center py-12 px-6">
          <div className="w-full max-w-md">
            ...
            <div className="border border-black rounded-lg p-6">
              ...
              <WireBtn variant="primary" full to="/">Reset Password</WireBtn>
            </div>
      ...
      <div className="flex-1 flex items-center justify-center py-12 px-6">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500 max-w-xs mx-auto">Your identity has been verified. Please choose a new password for your account.</p>
          </div>
          <div className="border border-gray-200 rounded-xl p-6">
            ...
            <div className="mb-5">
              <p className="text-xs font-medium text-gray-800 mb-2">Password requirements:</p>
              <div className="flex flex-col gap-1.5">
                <div className="flex items-center gap-2">
