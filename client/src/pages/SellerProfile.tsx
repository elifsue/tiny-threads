import { WireframeNav, WireframeFooter, ImgPlaceholder, TextBar, TextLines, WireBtn, ProductCard, WireSelect } from "@/components/wireframe/WireframePrimitives";
  ...
  return (
    <div className="flex flex-col min-h-[800px]">
      ...
      <div className="px-6 py-6 border-b border-gray-200 bg-gray-50">
        <div className="flex items-start gap-5">
          <div className="w-20 h-20 rounded-full bg-gray-200 border border-gray-300 flex-shrink-0" />
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-1">
