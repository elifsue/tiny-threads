import { WireframeNav, WireframeFooter, WireBtn, WireInput, WireSelect, TextBar, TextLines, SectionLabel } from "@/components/wireframe/WireframePrimitives";
          ...
          <div className="flex flex-col gap-4 mt-3 mb-5">
            {[
              ...
              <div key={item.method} className={`flex items-center gap-4 p-4 border rounded cursor-pointer ${i === 0 ? "border-gray-800 bg-gray-50" : "border-gray-200 hover:border-gray-400"}`}>
                <div className="w-10 h-10 border border-gray-200 rounded-lg flex items-center justify-center bg-gray-50 flex-shrink-0">
