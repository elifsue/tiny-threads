import { WireframeNav, WireframeFooter, ImgPlaceholder, TextBar, WireBtn } from "@/components/wireframe/WireframePrimitives";
            ...
            <div className="col-span-1">
              ...
              <div className="border border-gray-200 rounded-lg p-4 mb-4 bg-white">
                ...
                <div className="flex items-center gap-3">
                  <ImgPlaceholder label="" className="w-10 h-10 rounded-full flex-shrink-0" />
                  <div className="flex-1">
