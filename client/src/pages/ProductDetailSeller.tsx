import { WireframeNav, WireframeFooter, ImgPlaceholder, ProductCard, WireBtn, SectionLabel, TextLines, TextBar, DS, productImages,
      ...
      <div className="flex gap-6 px-6 py-6 items-start">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="border border-gray-200 rounded p-4">
            <div className="flex items-center gap-3 mb-3">
              {isHifi ? <img src={PROFILE_PHOTOS.p1} alt="Seller" className="w-10 h-10 rounded-full object-cover" /> : <div className="w-10 h-10 rounded-full bg-gray-200 border border-gray-300" />}
              <div className="flex-1">
