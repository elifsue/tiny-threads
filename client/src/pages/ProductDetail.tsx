import { WireframeNav, WireframeFooter, ImgPlaceholder, ProductCard, WireBtn, WireInput, SectionLabel, TextLines, TextBar } from "@/components/wireframe/WireframePrimitives";
...
export default function ProductDetail() {
        ...
        <div className="px-6 py-4">
          ...
          <div className="border border-black rounded p-5">
            <div className="flex items-center gap-2 mb-3">
              <h2 className="text-sm font-semibold text-black">Message</h2>
              <span className="text-[10px] font-medium text-black border border-black px-1.5 py-0.5 rounded">Optional</span>
            </div>
            <div className="border border-black rounded bg-white h-28 flex items-start p-3"><TextLines lines={2} /></div>
          </div>
        </div>
  ...
  /* ── Make an Offer Modal (Hi-Fi) ── */
  const hifiOfferModal = (
    <Dialog open={offerOpen} onOpenChange={setOfferOpen}>
        ...
        <div className="px-6 py-4">
          ...
          <div className="border border-gray-200 rounded p-5">
            ...
            <div className="border border-gray-300 rounded bg-white">
              <textarea className="w-full px-3 py-2.5 text-sm text-gray-600 placeholder:text-gray-400 bg-transparent resize-none outline-none" placeholder="Hi! Would you consider £6.50? Happy to buy right away." rows={4} />
            </div>
          </div>
        </div>
        <DialogFooter className="px-6 pb-6 pt-0 flex gap-3">
