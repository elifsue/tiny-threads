    ...
    <div data-hifi={isHifi || undefined} className="flex flex-col min-h-[800px]">
      ...
      <div className="px-6 py-8">
        <div className="max-w-[1200px] mx-auto">
          <div className="flex gap-8 items-center">
            ...
            {isHifi ? (
              <img src="https://d2xsxph8kpxj0f.cloudfront.net/310519663332337268/5dAnQahEr3KsPSbq9QaW5W/about-mission-KAHsBoxSczWg5iEQRNPbfq.webp" alt="Our Mission" className="w-[360px] h-[240px] rounded flex-shrink-0 object-cover" />
            ) : (
      ...
      <div className="px-6 py-8 bg-gray-50">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid grid-cols-3 gap-6 mt-4">
            {[
              { title: "Sustainability", desc: "Every item resold is one less in landfill. We're committed to reducing textile waste.", icon: "🌱" },
              { title: "Affordability", desc: "Quality children's clothing shouldn't break the bank. We make it easy to find great deals.", icon: "💰" },
              { title: "Community", desc: "We're building a community of parents who support each other through buying, selling, and sharing.", icon: "🤝" },
            ].map((val) => (
              <div key={val.title} className="border border-gray-200 rounded p-5 bg-white">
                {isHifi ? (
                  <div className="w-10 h-10 rounded bg-gray-100 mb-3 flex items-center justify-center text-lg">{val.icon}</div>
                ) : (
      ...
      <div className="px-6 py-8">
        <div className="max-w-[1200px] mx-auto">
          <div className="flex gap-8 items-center">
            {isHifi ? (
              <img src="https://d2xsxph8kpxj0f.cloudfront.net/310519663332337268/5dAnQahEr3KsPSbq9QaW5W/buyer-protection-3x2-YcqVFEzH6h3QNshu3KDXma.webp" alt="Buyer Protection" className="w-[360px] h-[240px] rounded flex-shrink-0 object-cover" />
            ) : (
              <ImgPlaceholder label="Protection Illustration" className="w-[360px] h-[240px] rounded flex-shrink-0" />
            )}
            <div className="flex-1">
              <SectionLabel>Buyer Protection</SectionLabel>
