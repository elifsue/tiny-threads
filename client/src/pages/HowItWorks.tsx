      ...
      <div className="flex flex-col min-h-[800px]">
          ...
          <div className="grid grid-cols-4 gap-6">
            {steps.map((s) => (
              <div key={s.step} className="text-center">
                <div className="w-14 h-14 rounded-full bg-white border-2 border-black flex items-center justify-center mx-auto mb-3">
        ...
        <div className="px-6 py-8 bg-white">
          <div className="flex gap-8 items-center">
            ...
            <ImgPlaceholder className="w-[320px] h-[220px] rounded flex-shrink-0" />
          </div>
        </div>
    ...
    <div className="flex flex-col min-h-[800px]">
      ...
      <div className="px-6 py-8 bg-gray-50">
        <div className="grid grid-cols-4 gap-6">
          {steps.map((s) => (
            <div key={s.step} className="text-center">
              <div className="w-14 h-14 rounded-full bg-gray-100 border-2 border-gray-300 flex items-center justify-center mx-auto mb-3">
                <span className="text-xl font-bold text-gray-500">{s.step}</span>
              </div>
      ...
      <div className="px-6 py-8">
        <div className="flex gap-8 items-center">
          ...
          <ImgPlaceholder label="Step 1 Illustration" className="w-[320px] h-[220px] rounded flex-shrink-0" />
        </div>
      </div>
      ...
      <div className="px-6 py-8 bg-gray-50">
        <div className="flex gap-8 items-center">
          <ImgPlaceholder label="Step 2 Illustration" className="w-[320px] h-[220px] rounded flex-shrink-0" />
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-10 h-10 rounded-full bg-gray-100 border-2 border-gray-300 flex items-center justify-center flex-shrink-0">
      ...
      <div className="px-6 py-8">
        <div className="flex gap-8 items-center">
          ...
          <ImgPlaceholder label="Step 3 Illustration" className="w-[320px] h-[220px] rounded flex-shrink-0" />
        </div>
      </div>
      ...
      <div className="px-6 py-8 bg-gray-50">
        <div className="flex gap-8 items-center">
          <ImgPlaceholder label="Step 4 Illustration" className="w-[320px] h-[220px] rounded flex-shrink-0" />
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-10 h-10 rounded-full bg-gray-100 border-2 border-gray-300 flex items-center justify-center flex-shrink-0">
