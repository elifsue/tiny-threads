import { WireframeNav, WireframeFooter, WireBtn, TextBar, WireSelect } from "@/components/wireframe/WireframePrimitives";
        ...
        <div className="grid grid-cols-5 gap-4">
          {followers.map((f) => (
            <div key={f.name} className="border border-gray-200 rounded-lg p-4 flex flex-col items-center text-center hover:shadow-sm transition-shadow">
              <div className="w-16 h-16 rounded-full bg-gray-200 border border-gray-300 mb-3" />
