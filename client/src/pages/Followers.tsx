...
const followerPhotos = [PROFILE_PHOTOS.p4, PROFILE_PHOTOS.p5, PROFILE_PHOTOS.p7, PROFILE_PHOTOS.p8, PROFILE_PHOTOS.p6, PROFILE_PHOTOS.p12, PROFILE_PHOTOS.p13, PROFILE_PHOTOS.p15, PROFILE_PHOTOS.p16, PROFILE_PHOTOS.p9, PROFILE_PHOTOS.p3, PROFILE_PHOTOS.p11, PROFILE_PHOTOS.p2, PROFILE_PHOTOS.p14, PROFILE_PHOTOS.p10, PROFILE_PHOTOS.p17];
      ...
      <div className="flex flex-col min-h-[800px]">
        ...
        <div className="px-6 border-b border-black">
          <div className="flex gap-6">
            ...
            <button className="py-3 text-sm font-medium text-black border-b-2 border-black">Followers (16)</button>
    ...
    <div data-hifi={isHifi || undefined} className="flex flex-col min-h-[800px]">
      ...
      <div className="px-6 border-b border-gray-200">
        <div className="flex gap-6">
          ...
          <button className="py-3 text-sm font-medium text-gray-800 border-b-2 border-gray-800">Followers (16)</button>
        ...
        <div className="grid grid-cols-5 gap-4">
          {followers.map((f, idx) => (
            <div key={f.name} className="border border-gray-200 rounded-lg p-4 flex flex-col items-center text-center hover:shadow-sm transition-shadow">
              {isHifi ? <img src={followerPhotos[idx % followerPhotos.length]} alt={f.name} className="w-16 h-16 rounded-full object-cover mb-3" /> : <div className="w-16 h-16 rounded-full bg-gray-200 border border-gray-300 mb-3" />}
