...
import { GoogleIcon, FacebookIcon, AppleIcon } from "@/components/wireframe/SocialIcons";
          ...
          <div className="border border-gray-200 rounded-lg p-6">
            <div className="flex flex-col gap-3 mb-5">
              <button className="h-10 border border-gray-300 rounded flex items-center justify-center gap-2 text-sm text-gray-600 hover:bg-gray-50">
                {isHifi ? <GoogleIcon size={20} /> : <div className="w-5 h-5 bg-gray-200 rounded-full" />}
                Continue with Google
              </button>
              <button className="h-10 border border-gray-300 rounded flex items-center justify-center gap-2 text-sm text-gray-600 hover:bg-gray-50">
                {isHifi ? <FacebookIcon size={20} /> : <div className="w-5 h-5 bg-gray-200 rounded-full" />}
                Continue with Facebook
              </button>
              <button className="h-10 border border-gray-300 rounded flex items-center justify-center gap-2 text-sm text-gray-600 hover:bg-gray-50">
                {isHifi ? <AppleIcon size={20} /> : <div className="w-5 h-5 bg-gray-200 rounded-full" />}
                Continue with Apple
              </button>
            </div>
            <div className="flex items-center gap-3 mb-5">
