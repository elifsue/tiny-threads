...
const chatListPhotosOS = [PROFILE_PHOTOS.p10, PROFILE_PHOTOS.p7, PROFILE_PHOTOS.p12];
      ...
      <div className="flex flex-1 border-b border-gray-200">
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            {[
              ...
              <div key={i} className="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 border-b border-gray-100">
                {isHifi ? <img src={chatListPhotosOS[i % chatListPhotosOS.length]} alt={c.name} className="w-10 h-10 rounded-full object-cover flex-shrink-0" /> : <div className="w-10 h-10 rounded-full bg-gray-200 flex-shrink-0" />}
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="px-4 py-3 border-b border-gray-200 flex items-center justify-between">
            <div className="flex items-center gap-3">
              {isHifi ? <img src={PROFILE_PHOTOS.p4} alt="emma_preloved" className="w-8 h-8 rounded-full object-cover" /> : <div className="w-8 h-8 rounded-full bg-gray-200" />}
              <div>
          ...
          <div className="flex-1 p-4 overflow-y-auto flex flex-col gap-4">
            {/* Seller message */}
            <div className="flex gap-2 max-w-[70%]">
              {isHifi ? <img src={PROFILE_PHOTOS.p4} alt="emma_preloved" className="w-7 h-7 rounded-full object-cover flex-shrink-0 mt-1" /> : <div className="w-7 h-7 rounded-full bg-gray-200 flex-shrink-0 mt-1" />}
              <div>
