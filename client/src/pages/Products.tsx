import { WireframeNav, WireframeFooter, ProductCard, WireSelect, WireBtn, TextBar } from "@/components/wireframe/WireframePrimitives";
...
export default function Products() {
  ...
  const brands = ["Next","H&M","Zara","M&S","Primark"];
