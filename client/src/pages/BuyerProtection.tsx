      ...
      <div className="px-6 py-8 bg-gray-50">
        <div className="max-w-[1200px] mx-auto">
          <div className="flex gap-8 items-center">
            ...
            {isHifi ? (
              <img src="https://d2xsxph8kpxj0f.cloudfront.net/310519663332337268/5dAnQahEr3KsPSbq9QaW5W/buyer-protection-refund-94v2fDWciDYVgFCe6Ydvr2.webp" alt="Refund Process" className="w-[360px] h-[240px] rounded flex-shrink-0 object-cover" />
            ) : (
              <ImgPlaceholder label="Refund Process Illustration" className="w-[360px] h-[240px] rounded flex-shrink-0" />
            )}
          </div>
        </div>
      </div>
