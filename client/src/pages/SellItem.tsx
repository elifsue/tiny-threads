import { WireframeNav, WireframeFooter, WireInput, WireSelect, WireTextarea, WireBtn, TextBar, DS,
        ...
        <div className="px-6 py-6 flex-1">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="flex gap-3">
              <WireBtn to="/profile" variant="outline" className="flex-1">Save as Draft</WireBtn>
              <WireBtn to="/profile" variant="primary" className="flex-1">Publish Listing</WireBtn>
            </div>
          </div>
        </div>
        <WireframeFooter />
    ...
    <div data-hifi={isHifi || undefined} className="flex flex-col min-h-[800px]">
      ...
      <div className="px-6 py-6 flex-1">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-sm text-gray-400 mb-6">List your item in just a few steps.</p>
          <div className="flex items-center gap-2 mb-8">
            {["Photos", "Details", "Pricing", "Shipping"].map((step, i) => (
              <div key={step} className="flex items-center gap-2 flex-1">
          ...
          <div className="flex gap-3">
            <WireBtn to="/profile" variant="secondary" className="flex-1">Save as Draft</WireBtn>
            <WireBtn to="/profile" variant="primary" className="flex-1">Publish Listing</WireBtn>
          </div>
        </div>
      </div>
