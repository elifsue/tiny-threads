...
const chatListPhotosOR = [PROFILE_PHOTOS.p10, PROFILE_PHOTOS.p7, PROFILE_PHOTOS.p12];
        ...
        <div className="flex flex-1 border-b border-black">
          <aside className="w-[300px] border-r border-black flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              <Link to="/offer-sent" className="flex items-center gap-3 px-4 py-3 border-b border-black cursor-pointer">
                <div className="w-10 h-10 flex-shrink-0 wireframe-circle-placeholder" />
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between"><TextBar width="80px" /><TextBar width="30px" /></div>
                  <div className="mt-0.5"><TextBar width="80%" /></div>
              ...
              {/* chloe_vintage — selected (current screen) */}
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="flex-1 p-4 overflow-y-auto flex flex-col gap-4">
              ...
              {/* OFFER RECEIVED bubble (from chloe_vintage — left side) */}
              <div className="flex gap-2">
                <div className="w-7 h-7 flex-shrink-0 mt-1 wireframe-circle-placeholder" />
                <div className="w-[360px]">
                  <div className="border border-black rounded-lg rounded-tl-none p-4 bg-white">
                    <div className="flex items-center gap-2 mb-3">
                      <span className="text-xs font-bold text-black uppercase tracking-wider">Offer Received</span>
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-3">
                      <div className="border border-black rounded p-2 text-center">
                        ...
                        <p className="text-sm font-bold text-black">&pound;8.00</p>
                      </div>
                      <div className="border border-black rounded p-2 text-center">
                        <p className="text-[10px] text-black mb-0.5">Their Offer</p>
                        <p className="text-sm font-bold text-black">&pound;6.00</p>
                      </div>
                    </div>
                    {/* Buyer message */}
                    ...
                    <div className="flex flex-col gap-2">
                      <div className="flex gap-2">
                        <WireBtn variant="outline" className="flex-1">Decline</WireBtn>
                        <WireBtn variant="primary" className="flex-1">Accept</WireBtn>
                      </div>
                      <WireBtn variant="outline" full>Offer Your Price</WireBtn>
                    </div>
                  </div>
                  <TextBar width="40px" className="mt-1" />
                </div>
      ...
      <div className="flex flex-1 border-b border-gray-200">
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <div className="flex items-center gap-3 px-4 py-3 bg-gray-100 border-l-2 border-gray-800">
              ...
              <div className="flex-1 min-w-0 overflow-hidden">
                ...
                <p className="text-xs text-gray-500 truncate">Offer received: &pound;6.00 for Boys Striped T-Shirt</p>
              </div>
              <div className="w-2 h-2 rounded-full bg-gray-800 flex-shrink-0" />
            </div>
            {/* remaining conversations */}
            {[
              ...
              <div key={i} className="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 border-b border-gray-100">
                {isHifi ? <img src={chatListPhotosOR[i % chatListPhotosOR.length]} alt={c.name} className="w-10 h-10 rounded-full object-cover flex-shrink-0" /> : <div className="w-10 h-10 rounded-full bg-gray-200 flex-shrink-0" />}
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="px-4 py-3 border-b border-gray-200 flex items-center justify-between">
            <div className="flex items-center gap-3">
              {isHifi ? <img src={PROFILE_PHOTOS.p13} alt="chloe_vintage" className="w-8 h-8 rounded-full object-cover" /> : <div className="w-8 h-8 rounded-full bg-gray-200" />}
              <div>
                <p className="text-sm font-semibold text-gray-700">chloe_vintage</p>
                <p className="text-[10px] text-gray-400">Last active 2 days ago</p>
              </div>
            </div>
            <WireBtn to="/seller-profile" variant="outline">View Profile</WireBtn>
          </div>
          ...
          <div className="flex-1 p-4 overflow-y-auto flex flex-col gap-4">
            ...
            <div className="flex gap-2 max-w-[70%] ml-auto flex-row-reverse">
              ...
              <div>
                <div className="bg-gray-800 rounded-lg rounded-tr-none px-3 py-2"><p className="text-sm text-white">Hi! Thanks for your interest in the t-shirt. Let me know if you have any questions.</p></div>
                <p className="text-[10px] text-gray-400 mt-1 text-right">2 days ago, 3:10 PM</p>
              </div>
            </div>
            {/* Buyer message */}
            <div className="flex gap-2 max-w-[70%]">
              {isHifi ? <img src={PROFILE_PHOTOS.p13} alt="chloe_vintage" className="w-7 h-7 rounded-full object-cover flex-shrink-0 mt-1" /> : <div className="w-7 h-7 rounded-full bg-gray-200 flex-shrink-0 mt-1" />}
              <div>
                <div className="bg-gray-100 rounded-lg rounded-tl-none px-3 py-2"><p className="text-sm text-gray-700">It looks great! I&apos;d like to make an offer.</p></div>
                <p className="text-[10px] text-gray-400 mt-1">2 days ago, 3:15 PM</p>
              </div>
            </div>
            {/* OFFER RECEIVED bubble (from chloe_vintage — left side) */}
            <div className="flex gap-2">
              {isHifi ? <img src={PROFILE_PHOTOS.p13} alt="chloe_vintage" className="w-7 h-7 rounded-full object-cover flex-shrink-0 mt-1" /> : <div className="w-7 h-7 rounded-full bg-gray-200 flex-shrink-0 mt-1" />}
              <div className="w-[360px]">
                <div className="border border-gray-300 rounded-lg rounded-tl-none p-4 bg-white shadow-sm">
                  <div className="flex items-center gap-2 mb-3">
                    <span className="text-xs font-semibold text-gray-700 uppercase tracking-wider">Offer Received</span>
                  ...
                  <Link to="/product-detail-buyer" className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg mb-3 bg-white hover:bg-gray-50 transition-colors cursor-pointer">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-400">Next &middot; 4 years / 104 cm &middot; Very good</p>
                    </div>
                  </Link>
                  {/* Price comparison */}
                  <div className="grid grid-cols-2 gap-3 mb-3">
                    <div className="border border-gray-200 rounded-lg p-2.5 text-center bg-white">
                      ...
                      <p className="text-sm font-bold text-gray-800">&pound;8.00</p>
                    </div>
                    <div className="border border-gray-300 rounded-lg p-2.5 text-center bg-gray-50">
                      <p className="text-[10px] text-gray-500 mb-0.5">Their Offer</p>
                      <p className="text-sm font-bold text-gray-800">&pound;6.00</p>
                    </div>
                  </div>
                  {/* Buyer message */}
                  <div className="border border-gray-200 rounded bg-gray-50 px-3 py-2 mb-3">
                    <p className="text-xs text-gray-600 leading-relaxed">Would you take &pound;6.00? I can pay straight away. My son needs it for school next week!</p>
                  </div>
                  {/* Actions */}
                  <div className="flex flex-col gap-2">
                    <div className="flex gap-2">
                      <WireBtn variant="secondary" className="flex-1">Decline</WireBtn>
                      <WireBtn variant="primary" className="flex-1">Accept</WireBtn>
                    </div>
                    <WireBtn variant="outline" full>Offer Your Price</WireBtn>
                  </div>
                </div>
                <p className="text-[10px] text-gray-400 mt-1">2 days ago, 3:16 PM</p>
              </div>
            </div>
          </div>
          {/* Message input */}
