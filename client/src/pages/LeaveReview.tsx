        ...
        <div className="px-6 py-6 flex-1">
          <div className="max-w-lg mx-auto">
            ...
            <div className="border border-black rounded p-5 mb-5">
              <div className="flex items-center gap-2 mb-4">
                <h2 className="text-sm font-semibold text-black">Rate Specific Aspects</h2>
            ...
            <div className="border border-black rounded p-5 mb-5">
              <div className="flex items-center gap-2 mb-3">
                <h2 className="text-sm font-semibold text-black">Your Review</h2>
                <span className="text-[10px] font-medium text-black border border-black px-1.5 py-0.5 rounded">Optional</span>
              </div>
              <div className="border border-black rounded bg-white h-28 flex items-start p-3" />
            </div>
            <div className="border border-black rounded p-5 mb-5">
              <div className="flex items-center gap-2 mb-2">
                <h2 className="text-sm font-semibold text-black">Add Photos</h2>
                <span className="text-[10px] font-medium text-black border border-black px-1.5 py-0.5 rounded">Optional</span>
              </div>
      ...
      <div className="px-6 py-6 flex-1">
        <div className="max-w-lg mx-auto">
          ...
          <div className="border border-gray-200 rounded p-5 mb-5">
            <div className="flex items-center gap-2 mb-4">
              <h2 className="text-sm font-semibold text-gray-700">Rate Specific Aspects</h2>
              <span className="text-[10px] font-medium text-gray-400 border border-gray-300 px-1.5 py-0.5 rounded">Optional</span>
            </div>
            <div className="flex flex-col gap-4">
              {["Item as described", "Communication", "Shipping speed", "Packaging"].map((aspect) => (
                <div key={aspect} className="flex items-center justify-between">
          ...
          <div className="border border-gray-200 rounded p-5 mb-5">
            <div className="flex items-center gap-2 mb-3">
              <h2 className="text-sm font-semibold text-gray-700">Your Review</h2>
              <span className="text-[10px] font-medium text-gray-400 border border-gray-300 px-1.5 py-0.5 rounded">Optional</span>
            </div>
            <div className="border border-gray-300 rounded bg-white">
              <textarea className="w-full px-3 py-2.5 text-sm text-gray-600 placeholder:text-gray-400 bg-transparent resize-none outline-none" placeholder="Tell other buyers about your experience — was the item as described? How was the packaging?" rows={5} />
            </div>
          </div>
          <div className="border border-gray-200 rounded p-5 mb-5">
            <div className="flex items-center gap-2 mb-2">
              <h2 className="text-sm font-semibold text-gray-700">Add Photos</h2>
              <span className="text-[10px] font-medium text-gray-400 border border-gray-300 px-1.5 py-0.5 rounded">Optional</span>
            </div>
